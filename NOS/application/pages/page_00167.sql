...
wwv_flow_imp_page.create_page(
 p_id=>167
,p_name=>'Brand Utility Update'
,p_alias=>'BRAND-UTILITY-UPDATE'
,p_page_mode=>'MODAL'
,p_step_title=>'Update'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(36090997435318212)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71808430989024743)
,p_name=>'P167_BRAND_CODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(116438583961070295)
,p_item_source_plug_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71808519366024744)
,p_name=>'P167_BRAND_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(116438583961070295)
,p_item_source_plug_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71808636969024745)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(71808761226024746)
,p_name=>'P167_BRAND_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106692857468370341)
,p_name=>'P167_CREATE_USER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(116438583961070295)
,p_item_source_plug_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106692937749370342)
,p_name=>'P167_CREATE_DATE'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106693069671370343)
,p_name=>'P167_UPDATE_USER'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(116438583961070295)
,p_item_source_plug_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(106693205740370344)
,p_name=>'P167_UPDATE_DATE'
,p_source_data_type=>'DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(116438583961070295)
,p_item_source_plug_id=>wwv_flow_imp.id(116438583961070295)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(36406283813386229)
,p_validation_name=>'Code_empty'
,p_validation_sequence=>10
,p_validation=>'P167_BRAND_CODE'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Field cannot be empty.'
,p_associated_item=>wwv_flow_imp.id(71808430989024743)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(36406366013386230)
,p_validation_name=>'Name_empty'
,p_validation_sequence=>20
,p_validation=>'P167_BRAND_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Field cannot be empty.'
,p_associated_item=>wwv_flow_imp.id(71808519366024744)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(38761811054655608)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(38761989443655609)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38762091096655610)
,p_name=>'Disable Code'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38762162306655611)
,p_event_id=>wwv_flow_imp.id(38762091096655610)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(36097075671318226)
...
,p_internal_uid=>36097075671318226
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(36097405861318228)
...
,p_attribute_02=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>36097405861318228
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(36096576281318225)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(116438583961070295)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Brand Utility Update'
,p_internal_uid=>36096576281318225
);
