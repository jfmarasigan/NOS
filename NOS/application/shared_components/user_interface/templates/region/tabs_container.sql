...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4315986588084159)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4316246065084159)
,p_plug_template_id=>wwv_flow_imp.id(4315986588084159)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4316550492084160)
,p_plug_template_id=>wwv_flow_imp.id(4315986588084159)
,p_name=>'Tabs'
