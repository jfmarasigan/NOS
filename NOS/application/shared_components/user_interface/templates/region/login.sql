...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4304399837084134)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4304682331084134)
,p_plug_template_id=>wwv_flow_imp.id(4304399837084134)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4304983529084135)
,p_plug_template_id=>wwv_flow_imp.id(4304399837084134)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4305291075084135)
,p_plug_template_id=>wwv_flow_imp.id(4304399837084134)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4305516880084135)
,p_plug_template_id=>wwv_flow_imp.id(4304399837084134)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4305868885084137)
,p_plug_template_id=>wwv_flow_imp.id(4304399837084134)
,p_name=>'Sub Regions'
