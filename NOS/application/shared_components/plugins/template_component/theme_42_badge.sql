...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4395831417084417)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4396180290084423)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4396436948084426)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4396756717084428)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4397045370084431)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4397332458084431)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4397627408084432)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4397951851084432)
,p_plugin_attribute_id=>wwv_flow_imp.id(4397627408084432)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4398342446084434)
,p_plugin_attribute_id=>wwv_flow_imp.id(4397627408084432)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4398721515084434)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4399079872084435)
,p_plugin_attribute_id=>wwv_flow_imp.id(4398721515084434)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4399452838084435)
,p_plugin_attribute_id=>wwv_flow_imp.id(4398721515084434)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4399822810084435)
,p_plugin_attribute_id=>wwv_flow_imp.id(4398721515084434)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4400262374084437)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4400592865084437)
,p_plugin_attribute_id=>wwv_flow_imp.id(4400262374084437)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4400943356084439)
,p_plugin_attribute_id=>wwv_flow_imp.id(4400262374084437)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4401345764084439)
,p_plugin_attribute_id=>wwv_flow_imp.id(4400262374084437)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1515878077358186612)
,p_plugin_id=>wwv_flow_imp.id(4395831417084417)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
