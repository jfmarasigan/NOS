...
,p_ajax_items_to_submit=>'P50_START_WITH'
,p_prn_units=>'INCHES'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45279379685848243)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(45279473454848244)
,p_event_id=>wwv_flow_imp.id(16029067625346120)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(16028949405346119)
,p_event_id=>wwv_flow_imp.id(45278640203848236)
,p_event_result=>'TRUE'
