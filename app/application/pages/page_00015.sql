...
'    QTY_UNITS,',
'    BALANCE,',
'    TO_CHAR(COSTS, ''999,999,999.00'')  || ''/ea'' as COSTS,',
'    WHSE',
'FROM (item_trans_pkg.get_table(:P15_ITEM_ID))',
'WHERE INV_DATE_ETA BETWEEN :P15_MONTH_FROM AND :P15_MONTH_TO;'))
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(14279728327795925)
,p_name=>'ROWNUM'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(14279924982795927)
,p_name=>'INV_SHP_NO'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'INV_SHP_NO'
,p_data_type=>'VARCHAR2'
,p_is_query_only=>false
,p_item_type=>'NATIVE_TEXT_FIELD'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(15644251681476745)
,p_view_id=>wwv_flow_imp.id(11650598378426934)
,p_display_seq=>31
,p_column_id=>wwv_flow_imp.id(14279728327795925)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(15646019992476759)
,p_view_id=>wwv_flow_imp.id(11650598378426934)
,p_display_seq=>33
,p_column_id=>wwv_flow_imp.id(14279924982795927)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
