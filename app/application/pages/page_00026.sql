...
'mapP26Keys();',
'setInputFilter($("#P26_NEW_QTY_4"), function(value) {  return /^\d*$/.test(value) || /-/.test(value);}, "Only digits are allowed");',
'setInputFilter($("#P26_NEW_QTY_3"), function(value) {  return /^\d*$/.test(value) || /-/.test(value);}, "Only digits are allowed");',
'setInputFilter($("#P26_NEW_QTY_2"), function(value) {  return /^\d*$/.test(value) || /-/.test(value);}, "Only digits are allowed");',
'setInputFilter($("#P26_NEW_QTY_1"), function(value) {  return /^\d*$/.test(value) || /-/.test(value);}, "Only digits are allowed");',
''))
...
'            1',
'        );',
'        INSERT INTO NIT005 (ITEM_ID, QTY_REASON_ID, OLD_QTY, QTY_CHANGE, NEW_QTY, CREATE_USER, CREATE_DATE, UOM_ID, WAREHOUSE_ID)',
'        VALUES(',
'            :P26_ITEM_ID, ',
'            :P26_REASON, ',
'            :P26_CURRENT_QTY_1,',
...
'            SYSDATE(),',
'            1,',
'            :P26_WAREHOUSE) RETURNING QTY_ADJUSTMENT_ID INTO l_qty_adjustment_id; ',
'        ',
'        IF :P26_CURRENT_QTY_1 > :P26_NEW_QTY_1 THEN',
...
'                :P26_WAREHOUSE,',
'                1,',
'                ''MA '' || TO_CHAR(l_qty_adjustment_id, ''000000''),',
'                SYSDATE,',
'                ''O'',',
'                NULL,',
'                ABS(:P26_NEW_QTY_1 - :P26_CURRENT_QTY_1)',
