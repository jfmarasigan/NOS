...
'            return;',
'        }',
'    } else if ($v(''P160_MODULE'') === "Collection Entry") {',
'        switch ($v(''P160_TYPE'')) {',
'            case null:',
'                apex.message.showErrors({',
'                type: "error",',
...
'            return;',
'        }',
'    } else if ($v(''P160_MODULE'') === "Credit Memo") {',
'        targetPage = 252;',
'    } else if ($v(''P160_MODULE'') === "Customer Masterfile") {',
'        switch ($v(''P160_TYPE'')) {',
'            case null:',
'                apex.message.showErrors({',
'                type: "error",',
...
'            return;',
'        } ',
'    } else if ($v(''P160_MODULE'') === "Cashiering") {',
'        switch ($v(''P160_TYPE'')) {',
'            case null:',
'                apex.message.showErrors({',
'                type: "error",',
...
'            return;',
'        } ',
'    } else if ($v(''P160_MODULE'') === "Gift Certificate") {',
'        switch ($v(''P160_TYPE'')) {',
'            case null:',
'                apex.message.showErrors({',
'                type: "error",',
...
'            });',
'            return;',
'            case "Gift Certificate Type":',
'                targetPage = 231;',
'                break;',
'            case "Gift Certificate Status":',
'                targetPage = 235;',
'                break;',
'            default :',
'                apex.message.showErrors({',
