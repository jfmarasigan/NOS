prompt --application/shared_components/user_interface/templates/page/standard_no_footer
begin
--   Manifest
--     TEMPLATE: STANDARD_NO_FOOTER
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(5671392681337017)
,p_theme_id=>42
,p_name=>'Standard - No Footer'
,p_internal_name=>'STANDARD_NO_FOOTER'
,p_is_popup=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5671749720337026)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5672291543337026)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5672784351337028)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5673250519337028)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5673770976337028)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5674295917337028)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5674789280337029)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5675249385337029)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5675760435337029)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(5676253832337031)
,p_page_template_id=>wwv_flow_imp.id(5671392681337017)
