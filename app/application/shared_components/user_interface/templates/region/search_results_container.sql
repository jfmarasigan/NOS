...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4244953885084029)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4245263054084031)
,p_plug_template_id=>wwv_flow_imp.id(4244953885084029)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4245572618084031)
,p_plug_template_id=>wwv_flow_imp.id(4244953885084029)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4245844595084031)
,p_plug_template_id=>wwv_flow_imp.id(4244953885084029)
,p_name=>'Sub Regions'
