...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4300851934084125)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4301165404084126)
,p_plug_template_id=>wwv_flow_imp.id(4300851934084125)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4301438873084128)
,p_plug_template_id=>wwv_flow_imp.id(4300851934084125)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4301741743084128)
,p_plug_template_id=>wwv_flow_imp.id(4300851934084125)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4302069791084129)
,p_plug_template_id=>wwv_flow_imp.id(4300851934084125)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4302305399084129)
,p_plug_template_id=>wwv_flow_imp.id(4300851934084125)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
