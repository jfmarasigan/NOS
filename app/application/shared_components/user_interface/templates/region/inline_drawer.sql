...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4250156252084037)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4250429084084037)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4250777751084037)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4251005319084037)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4251320638084037)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4251676171084039)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4251993810084039)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4252212899084039)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4252506568084039)
,p_plug_template_id=>wwv_flow_imp.id(4250156252084037)
,p_name=>'Sub Regions'
