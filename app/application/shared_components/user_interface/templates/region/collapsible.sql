...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4286031257084101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4286304579084103)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4286602927084103)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4286920921084103)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4287234921084103)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4287515771084103)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4287851994084104)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4288111084084104)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4288486612084104)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4288713665084106)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4289007357084106)
,p_plug_template_id=>wwv_flow_imp.id(4286031257084101)
,p_name=>'Sub Regions'
