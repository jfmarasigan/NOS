...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4254771719084042)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4255075189084042)
,p_plug_template_id=>wwv_flow_imp.id(4254771719084042)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4255318038084042)
,p_plug_template_id=>wwv_flow_imp.id(4254771719084042)
,p_name=>'Sub Regions'
