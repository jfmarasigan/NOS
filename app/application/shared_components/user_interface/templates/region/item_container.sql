...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4247626305084034)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4247950788084034)
,p_plug_template_id=>wwv_flow_imp.id(4247626305084034)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4248217446084034)
,p_plug_template_id=>wwv_flow_imp.id(4247626305084034)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4248514055084034)
,p_plug_template_id=>wwv_flow_imp.id(4247626305084034)
,p_name=>'Button Start'
