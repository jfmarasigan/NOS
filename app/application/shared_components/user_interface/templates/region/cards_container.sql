...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(4265387714084060)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4265672632084062)
,p_plug_template_id=>wwv_flow_imp.id(4265387714084060)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4265971224084064)
,p_plug_template_id=>wwv_flow_imp.id(4265387714084060)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4266233908084064)
,p_plug_template_id=>wwv_flow_imp.id(4265387714084060)
,p_name=>'Sub Regions'
