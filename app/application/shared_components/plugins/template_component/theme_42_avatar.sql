...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4386780793084310)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4387052264084356)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4387385305084364)
,p_plugin_attribute_id=>wwv_flow_imp.id(4387052264084356)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4387774021084365)
,p_plugin_attribute_id=>wwv_flow_imp.id(4387052264084356)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4388128396084367)
,p_plugin_attribute_id=>wwv_flow_imp.id(4387052264084356)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4388597456084368)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4387052264084356)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4388862993084370)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4389193288084371)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4389440056084373)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4389799283084373)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4390004390084375)
,p_plugin_attribute_id=>wwv_flow_imp.id(4389799283084373)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4390469570084375)
,p_plugin_attribute_id=>wwv_flow_imp.id(4389799283084373)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4390851705084376)
,p_plugin_attribute_id=>wwv_flow_imp.id(4389799283084373)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4391271283084376)
,p_plugin_attribute_id=>wwv_flow_imp.id(4389799283084373)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4391618960084378)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4391956064084378)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4392351944084378)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4392724869084379)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4393115107084379)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4393593337084381)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4393959562084382)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4394340038084382)
,p_plugin_attribute_id=>wwv_flow_imp.id(4391618960084378)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4394764847084384)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804437583948198080)
,p_plugin_id=>wwv_flow_imp.id(4386780793084310)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
