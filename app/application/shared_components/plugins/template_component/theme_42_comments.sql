...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4404683367084453)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1804290107112116173)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405158143084460)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405429225084460)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4405718047084462)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4406061481084462)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4406352632084462)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4410994883084476)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1804290107112116173)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4406684250084464)
,p_plugin_attribute_id=>wwv_flow_imp.id(4406352632084462)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4407015232084464)
,p_plugin_attribute_id=>wwv_flow_imp.id(4406352632084462)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4407450308084465)
,p_plugin_attribute_id=>wwv_flow_imp.id(4406352632084462)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4407831778084467)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4406352632084462)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4408192491084467)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4408448115084468)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4408775769084470)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4409038459084471)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4410531163084475)
,p_plugin_attribute_id=>wwv_flow_imp.id(4409038459084471)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4409389752084471)
,p_plugin_attribute_id=>wwv_flow_imp.id(4409038459084471)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4409728866084473)
,p_plugin_attribute_id=>wwv_flow_imp.id(4409038459084471)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4410163043084475)
,p_plugin_attribute_id=>wwv_flow_imp.id(4409038459084471)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4410994883084476)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4411282969084478)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4411525032084478)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4411801427084479)
,p_plugin_attribute_id=>wwv_flow_imp.id(4411525032084478)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4412288717084479)
,p_plugin_attribute_id=>wwv_flow_imp.id(4411525032084478)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4412623342084481)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1804422774545217676)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804422183040210219)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804477806710192098)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804630024423062869)
,p_plugin_id=>wwv_flow_imp.id(4404683367084453)
