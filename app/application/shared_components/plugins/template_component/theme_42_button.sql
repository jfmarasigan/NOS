...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4401911135084443)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4402246402084445)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4402576011084446)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4402844298084448)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4403153345084448)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4403488708084450)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4403747891084450)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404011557084450)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4404305044084451)
,p_plugin_id=>wwv_flow_imp.id(4401911135084443)
,p_attribute_scope=>'COMPONENT'
